...
interface AppointmentLogsProps {
...
const activities = [
  ...
  {
    log: 'Appointment status changed from Pending payment to Completed.',
    date: subHours(Date.now(), 21).getTime()
  }

];

export const AppointmentLogs: FC<AppointmentLogsProps> = (props) => {
