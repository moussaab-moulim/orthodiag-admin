...
export const getBoard =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.getBoard(data));
  };
...
export const createColumn =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.createColumn(data));
  };
...
export const updateColumn =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.updateColumn(data));
  };
...
export const clearColumn =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.clearColumn(columnId));
  };
...
export const createCard =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.createCard(data));
  };
...
export const updateCard =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.updateCard(data));
  };
...
export const deleteCard =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.deleteCard(cardId));
  };
...
export const addComment =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(kanbanSlice.actions.addComment(data));
  };
...
export const addChecklist =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.addChecklist({
        cardId,
        checklist: data,
      })
    );
...
export const updateChecklist =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.updateChecklist({
        cardId,
        checklist: data,
      })
    );
...
export const deleteChecklist =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.deleteChecklist({
        cardId,
        checklistId,
      })
    );
...
export const addCheckItem =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.addCheckItem({
        cardId,
        checklistId,
        checkItem: data,
      })
...
export const updateCheckItem =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.updateCheckItem({
        cardId,
        checklistId,
        checkItem: data,
      })
...
export const deleteCheckItem =
  ...
  async (dispatch): Promise<void> => {
    ...
    dispatch(
      kanbanSlice.actions.deleteCheckItem({
        cardId,
        checklistId,
        checkItemId,
      })
